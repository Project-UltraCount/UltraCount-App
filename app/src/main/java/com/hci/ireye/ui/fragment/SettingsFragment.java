...
import com.hci.ireye.ui.customview.SettingsPage;

import java.time.Duration;

import static com.hci.ireye.util.MyUtil.formatDurationString;
import static com.hci.ireye.util.MyUtil.getPercentage;
import static com.hci.ireye.util.MyUtil.getValueByRatio;
                ...
                .addSwitchTab("switch_notification",
                        ...
                        new CompoundButton.OnCheckedChangeListener() {
                            ...
                            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                                ...
                                if (!isChecked) {
                                    ((MainInterfaceActivity)mContext).mNotificationMaker.cancelCurrentPresent();
                                }
                            }
                        })
                ...
                .addSwitchTab("switch_notify_if_offline",
                        ...
                        new CompoundButton.OnCheckedChangeListener() {
                            ...
                            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                                ...
                                if (!isChecked) {
                                    ((MainInterfaceActivity)mContext).mNotificationMaker.cancelAllDeviceOffline();
                                }
                            }
                        })
