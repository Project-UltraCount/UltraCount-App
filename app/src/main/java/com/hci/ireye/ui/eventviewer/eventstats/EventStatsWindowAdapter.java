...
public class EventStatsWindowAdapter extends RecyclerView.Adapter<EventStatsWindowAdapter.StatsEntryViewHolder> {

    private Context mContext;
    private IGetEntry mIGetEntry;

    public EventStatsWindowAdapter(Context context, IGetEntry iGetEntry) {
        mContext = context;
    ...
    public StatsEntryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new StatsEntryViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_eventviewer_stats_entry, parent, false));
    }
