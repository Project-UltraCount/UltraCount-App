...
public class ChartsWindowAdapter extends RecyclerView.Adapter<ChartsWindowAdapter.ChartsEntryViewHolder> {

    private Context mContext;
    private IGetEntry mIGetEntry;

    public ChartsWindowAdapter(Context context, IGetEntry iGetEntry) {
        mContext = context;
    ...
    public ChartsEntryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ChartsEntryViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_charts_entry, parent, false));
    }
