...
public class AliyunRequestExecutor {
    private final Map<String, String> mParameters;

    private static final String API = "https://iot.cn-shanghai.aliyuncs.com/";

    private static final String ACCESS_KEY_ID = "LTAI5t5jK7G15gb9D7yRMV16";  // RAM AccessKeyId
    private static final String ACCESS_KEY_SECRET = "Uy4lVE2ZWqVdZLxWKP7Vl2u7iGvzco";

    private static final String IOT_INSTANCE_ID = "iot-06z00dqdyd9a3m8";
    ...
    private static String getSignature(Map<String, String> parameters) {
        ...
        final String key = AliyunRequestExecutor.ACCESS_KEY_SECRET + "&";
        try {
    ...
    public AliyunRequestExecutor(String action) {
        this.mParameters = new HashMap<>();
        mParameters.put("Action", action);
    }

    public AliyunRequestExecutor addParam(String key, String value) {
    ...
    private Request build() {
        ...
        mParameters.put("Version", "2018-01-20");
        mParameters.put("Format", "JSON");
        mParameters.put("AccessKeyId", ACCESS_KEY_ID);
        mParameters.put("IotInstanceId", IOT_INSTANCE_ID);
        ...
        mParameters.put("RegionId", "cn-shanghai");
